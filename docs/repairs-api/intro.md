...
| <span id="n-sms-env">CONFIRMATION_SMS_NOTIFY_TEMPLATE_ID</span>  | Id of the template that will be sent to customers |
| <span id="n-email-env">CONFIRMATION_EMAIL_NOTIFY_TEMPLATE_ID</span>  | Id of the template that will be sent to customers |
